$(document).ready(function () {
    ...
    $(function () {
        ...
        header = $("#header").innerHeight();
        sidebarHeight = winHeight - header;
        $(".sidebar").css({"height":sidebarHeight,"top":header});
    });
    ...
    //select all checkbox  
    $("#sales,#customers,#products,#stock,#employee,#accounts,#finance,#settings").change(function() {
      if($(this).is(":checked")) {
          $(this).parents('.app-form').find(".custom-control-input").each(function() {
    ...
    companies.on("click", "th.select-checkbox", function() {
      ...
      yearData.on("click", "th.select-checkbox", function() {
        if ($("th.select-checkbox").hasClass("selected")) {
